...
<link rel="stylesheet" href="_assets/css/jqm-demos.css">
	...
	<div  data-role="page" id="demo-page" data-title="CampusBox | Public">
    ...
    <div data-role="header" data-position="fixed" data-theme="b">
        <div data-role="navbar" data-iconpos="top">
			...
			<li><a href="home" data-ajax="false" data-icon="home" >Home<span id="newhomeposts" class="small"></span></a></li>
                <li><a href="all" data-ajax="false" data-icon="grid" class="ui-btn-active">Public<span id="newallposts" class="small"></span></a></li>
...
$result=mysqli_query($conn,"SELECT * FROM `all` WHERE 1 ORDER BY no DESC LIMIT 30");
$id=$_SESSION['uid'];
$turn=1;
...
echo "<1m";
    if(mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM `alllike` WHERE `userid`='".$id."' AND `postid`='".$row[0]."' ")))
...
if(isset($anId))
echo '<a href="javascript:void(0)" onClick="ldfncall('.$anId.', 1 )" ><div class="shmore">
...
$(window).on('load', function () {
  ...
  $( document ).on( "pagecreate create", "#demo-page", function() {
    ...
    $( ".popuplink" ).on( "click", function() {       
        ...
        $( "#wholiked" ).html("Searching..&nbsp;<img src='images/thumbnails/search.gif'>").load("wholiked?postid="+listitem.attr('id')+"&section="+1, function(){$( "#popupscr" ).popup( "open" );});
...
xmlhttp.open("GET","response?postid="+str1+"&val="+1,true);
xmlhttp.send();
}
